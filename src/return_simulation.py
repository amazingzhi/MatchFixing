...
# global variables
directory = '../predictions/predictions_18_test_game/all_before_18/best_predictions_each_algorithm'
bet_path = '../data/final/betting spread/cleaned_betting_line_2018.csv'
...
plot_mapping = {'DNN': 'Deep_Neural_Networks', 'SGD': 'Stochastic_Gradient_Descent', 'LR': 'Linear_Regression',
                'RF': 'Random_Forest', 'SVM': 'Support_Vector_Machine', 'DTR': 'Decision_Tree_Regression',
                'Light': 'Light_Gradient_Boosting_Machine', 'GBR': 'Gradient_Boosting_Regression',
                'Lasso': 'Lasso_Regression', 'Ridge': 'Ridge_Regression'}
b_pointspread = 0.95
initial_stake = 100
common_columns = ["GAME_ID", "GAME_DATE_EST", "team_id", "oppo_id", "PTS_team", "pointspread", "loc"]
map_home_away = {'DNN': 'away', 'LR': 'home', 'RF': 'home', 'SGD': 'home', 'SVM': 'away', 'Light': 'away',
                 'Ridge': 'home', 'Lasso': 'home', 'GBR': 'away', 'DTR': 'home'}
